...
namespace CS311_ETEEAP_Batch2_2025_TRINIDAD
{
    public partial class frmequipments : Form
    {
        ...
        Class1 equipments = new Class1("127.0.0.1", "itc127_assessment", "aries", "trinidad");
        ...
        private void deleteeqpbtn_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                try
                {
                    ...
                    {
                        string logQuery = $"INSERT INTO tblequipmentslogs (datelog, timelog, assetnumber, performedby, action, module) " +
