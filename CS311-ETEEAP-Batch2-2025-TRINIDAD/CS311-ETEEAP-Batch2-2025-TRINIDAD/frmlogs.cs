...
namespace CS311_ETEEAP_Batch2_2025_TRINIDAD
{
    public partial class frmlogs : Form
    {
        ...
        Class1 logs = new Class1("127.0.0.1", "itc127_assessment", "aries", "trinidad");
        ...
        public void LoadEquipmentLogsData()
        {
            ...
            string equipmentquery = "SELECT * FROM tblequipmentslogs ORDER BY datelog DESC, timelog DESC";
        ...
        private void deleteeqplogs_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                try
                {
                    Class1 db = new Class1("127.0.0.1", "itc127_assessment", "aries", "trinidad");
                    db.executeSQL("TRUNCATE TABLE tblequipmentslogs");
